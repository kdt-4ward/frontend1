...
export default function SolutionPreviewScreen() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    apiFetch(`/analysis/stats/${user.couple_id}?end_date=2025-07-08`)
      .then(res => res.json())
      .then(data => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <StackedBarChart title="유저 1 감정 비율" data={makeStackedBarChartData(weeklyData, '1')} />
      <StackedBarChart title="유저 2 감정 비율" data={makeStackedBarChartData(weeklyData, '2')} />
