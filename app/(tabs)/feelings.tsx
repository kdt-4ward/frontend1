...
//             </Text>
//             <Text style={{ color: "#888", fontSize: 12, marginBottom: 8 }}>기록 시간: {detail.time}</Text>
//             <Button title="수정" onPress={() => setEditMode(true)} />
//           </>
//         ) : (
//           <Text style={{ color: "#bbb", marginTop: 14 }}>날짜를 선택하면 감정 기록이 표시됩니다.</Text>
//         )}
//       </View>
//       {/* 오늘 감정 기록이 없고 플로우가 안 열려 있을 때 진입 버튼 제공 */}
//       {!todayRecord && !showRecordFlow && !editMode && (
//         <View style={{ marginTop: 28, alignItems: "center" }}>
//           <Button title="감정 기록하기" onPress={() => setShowRecordFlow(true)} />
//         </View>
//       )}
//       {/* 오늘 기록 없으면 기록 플로우 모달 자동 */}
//       <Modal
...
//           <EmotionRecordFlow
//             // 수정할 때는 해당 날짜/기록 전달
//             editDate={editMode && detailDate ? detailDate : undefined}
//             onComplete={() => {
